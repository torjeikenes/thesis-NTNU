...
%This thesis aims to address these challenges in verifying asynchronous events by exploring the development of a reference model that accurately simulates these events, and evaluate whether a an architecture consisting of 
